import 'package:app_aula13/screens/scanner_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _abrirLeitor() async {
    ...
    if (resultado != null && resultado.isNotEmpty) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Qr code lido com sucesso')));
    }
  }
  ...
  Widget build(BuildContext context) {
    final conteudo =
        _ultimoConteudo ?? 'Nada lido ainda ! Toque no botão abaixo';
    return Scaffold(
      appBar: AppBar(
                    ...
                    onPressed: _ultimoConteudo == null
                        ...
                        : () async {
                            await Clipboard.setData(
                                ClipboardData(text: _ultimoConteudo!));
                            if (!mounted) return;
