import 'package:app_aula05/data/dog_dao.dart';
import 'package:app_aula05/models/dog.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<Dog>>?
      _futureDogs; // vai carregar os dogs salvos no banco de dados
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
                labelText: 'Nome do pet', border: OutlineInputBorder()),
