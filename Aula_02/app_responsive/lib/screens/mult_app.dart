...
class multiplicationController extends GetxController {
  ...
  // Method to multiply the number1 and number2
  void multiplyValue() {
    result.value = number1.value * number2.value;
  }
}

class MultiplyApp extends StatelessWidget {
  final multiplicationController controller =
      Get.put(multiplicationController()); // Injects controller
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: controller.multiplyValue,
            child: Text('Multiply'),
          ),
          SizedBox(
            height: 16,
